...
public class SeekBar extends View
{
    ...
    private void init(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        setValue(typedArray.getFloat(R.styleable.SeekBar_value, minValue));
        setValueBarColor(typedArray.getColor(R.styleable.SeekBar_value_bar_color, 0xFF5b5b5b));
        setValueBarProgressColor(typedArray.getColor(R.styleable.SeekBar_value_progress_bar_color, 0xFF5b5b5b));
        setIndicatorOuterCircleColor(typedArray.getColor(R.styleable.SeekBar_value_indicator_outer_circle_color, 0x805b5b5b));
        setIndicatorInnerCircleColor(typedArray.getColor(R.styleable.SeekBar_value_indicator_inner_circle_color, 0xFF5b5b5b));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(modeHeight == MeasureSpec.AT_MOST) height = desiredHeight;
    ...
    float calculateHintX(MotionEvent motionEvent) {
        ...
        float viewX       = motionEvent.getRawX() - motionEvent.getX();

        if(hintX < (viewX + valueBar.x - valueHint.getWidth() / 2)) {
            hintX = (viewX + valueBar.x - valueHint.getWidth() / 2);
        }
        else if(hintX > (viewX + valueBar.x + valueBar.length - valueHint.getWidth() / 2)) {
            hintX = (viewX + valueBar.x + valueBar.length - valueHint.getWidth() / 2);
        }
        if(hintX < 0) {hintX = 0;}
